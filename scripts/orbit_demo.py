    ...
    with TestClient(app) as client:
        ...
        with database.session_factory() as session:
            ...
            current = ConnectorInstance(
                ...
                device_name="本地演示设备",
                client_version="agentpost-connect/0.1.14",
                status="active",
...
def _settings(data_dir: Path, port: int) -> Settings:
    return Settings(
        ...
        connector_release_version="0.1.14",
        connector_wheel_url="https://agentpost.me/downloads/agentpost-0.1.14-py3-none-any.whl",
        connector_wheel_sha256="dbbb8dc61b95742eeb1a8b02f9fa187994225bd50c3bdabc9077ef1ee56b97f6",
        log_level="WARNING",
    )
