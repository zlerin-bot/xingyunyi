    ...
    with TestClient(app) as client:
        ...
        with database.session_factory() as session:
            ...
            current = ConnectorInstance(
                ...
                device_name="本地演示设备",
                client_version="agentpost-connect/0.1.13",
                status="active",
...
def _settings(data_dir: Path, port: int) -> Settings:
    return Settings(
        ...
        connector_release_version="0.1.13",
        connector_wheel_url="https://agentpost.me/downloads/agentpost-0.1.13-py3-none-any.whl",
        connector_wheel_sha256="425e4596afedd32905c900ca90bf9a0e9c270e469ac428f7fa8733b43a78c510",
        log_level="WARNING",
    )
