    ...
    with TestClient(app) as client:
        ...
        with database.session_factory() as session:
            ...
            current = ConnectorInstance(
                ...
                device_name="本地演示设备",
                client_version="agentpost-connect/0.1.18",
                status="active",
...
def _settings(data_dir: Path, port: int) -> Settings:
    return Settings(
        ...
        connector_release_version="0.1.18",
        connector_wheel_url="https://agentpost.me/downloads/agentpost-0.1.18-py3-none-any.whl",
        connector_wheel_sha256="4edac3b5e45377cf1598bc49ea6c9e53d8a9f003262124a94983c91c44abb2b3",
        log_level="WARNING",
    )
