    ...
    with TestClient(app) as client:
        ...
        with database.session_factory() as session:
            ...
            current = ConnectorInstance(
                ...
                device_name="本地演示设备",
                client_version="agentpost-connect/0.1.15",
                status="active",
...
def _settings(data_dir: Path, port: int) -> Settings:
    return Settings(
        ...
        connector_release_version="0.1.15",
        connector_wheel_url="https://agentpost.me/downloads/agentpost-0.1.15-py3-none-any.whl",
        connector_wheel_sha256="dcf9f8d414efa478a4192c8892902cfd2e3aa0c6219db128680b55c51f5601df",
        log_level="WARNING",
    )
