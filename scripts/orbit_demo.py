...
def _settings(data_dir: Path, port: int) -> Settings:
    return Settings(
        ...
        connector_release_version="0.1.11",
        connector_wheel_url="https://agentpost.me/downloads/agentpost-0.1.11-py3-none-any.whl",
        connector_wheel_sha256="1d7e9acfb4e2b57ba877e118a304df2880ee4327abc48a2fccfe08a37f30e935",
        log_level="WARNING",
    )
