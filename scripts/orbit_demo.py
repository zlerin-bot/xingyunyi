    ...
    with TestClient(app) as client:
        ...
        with database.session_factory() as session:
            ...
            current = ConnectorInstance(
                ...
                device_name="本地演示设备",
                client_version="agentpost-connect/0.1.24",
                status="active",
...
def _settings(data_dir: Path, port: int) -> Settings:
    return Settings(
        ...
        connector_release_version="0.1.24",
        connector_wheel_url="https://agentpost.me/downloads/agentpost-0.1.24-py3-none-any.whl",
        connector_wheel_sha256="f38d98390015542ba80ff21bb846fe96974b68f627e621d08726a9317efc9952",
        log_level="WARNING",
    )
