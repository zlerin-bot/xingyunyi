    ...
    with TestClient(app) as client:
        ...
        with database.session_factory() as session:
            ...
            current = ConnectorInstance(
                ...
                device_name="本地演示设备",
                client_version="agentpost-connect/0.1.22",
                status="active",
...
def _settings(data_dir: Path, port: int) -> Settings:
    return Settings(
        ...
        connector_release_version="0.1.22",
        connector_wheel_url="https://agentpost.me/downloads/agentpost-0.1.22-py3-none-any.whl",
        connector_wheel_sha256="6e3987f73d22e6e0fbcbf5626fcd160be27ae16c1311afbac273a28b4255b91f",
        log_level="WARNING",
    )
