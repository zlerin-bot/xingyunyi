    ...
    with TestClient(app) as client:
        ...
        with database.session_factory() as session:
            ...
            current = ConnectorInstance(
                ...
                device_name="本地演示设备",
                client_version="agentpost-connect/0.1.23",
                status="active",
...
def _settings(data_dir: Path, port: int) -> Settings:
    return Settings(
        ...
        connector_release_version="0.1.23",
        connector_wheel_url="https://agentpost.me/downloads/agentpost-0.1.23-py3-none-any.whl",
        connector_wheel_sha256="031a144c2a1077e5b259611b325f192dc068f01a5ad6c409567fbcef962b20f0",
        log_level="WARNING",
    )
