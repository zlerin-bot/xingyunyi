    ...
    with TestClient(app) as client:
        ...
        with database.session_factory() as session:
            ...
            current = ConnectorInstance(
                ...
                device_name="本地演示设备",
                client_version="agentpost-connect/0.1.29",
                status="active",
...
def _settings(data_dir: Path, port: int) -> Settings:
    return Settings(
        ...
        connector_release_version="0.1.29",
        connector_wheel_url="https://agentpost.me/downloads/agentpost-0.1.29-py3-none-any.whl",
