    ...
    with TestClient(app) as client:
        ...
        with database.session_factory() as session:
            ...
            current = ConnectorInstance(
                ...
                device_name="本地演示设备",
                client_version="agentpost-connect/0.1.25",
                status="active",
...
def _settings(data_dir: Path, port: int) -> Settings:
    return Settings(
        ...
        connector_release_version="0.1.25",
        connector_wheel_url="https://agentpost.me/downloads/agentpost-0.1.25-py3-none-any.whl",
        connector_wheel_sha256="1ecc4562ac3885de0a8aaa91e4fd9fff84c3bd080f6ecc47aa3596861356ccc7",
        log_level="WARNING",
    )
