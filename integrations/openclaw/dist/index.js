...
import { AgentPostHttpClient, AgentPostHttpError, safeToolError } from "./client.js";
const messageTypes = [
    "message",
    "task",
    "request",
...
const idempotencyKey = Type.Optional(Type.String({
    minLength: 1,
    maxLength: 255,
    description: "Reuse this exact value when explicitly retrying an uncertain call."
}));
const attachmentIds = Type.Optional(Type.Array(Type.String({
    format: "uuid"
}), {
    maxItems: 32,
    uniqueItems: true
...
export default defineToolPlugin({
    ...
    tools: (tool)=>[
            ...
            tool({
                ...
                description: "List every organization available to this Agent. Use this to match an explicitly named group before sending, especially when a default Agent participates in multiple groups.",
                parameters: Type.Object({}, {
                    additionalProperties: false
                }),
                outputSchema: resultSchema,
